...
# theta levels
python $INTP $mlfile $tlfile zh pt
python $INTP $mlfile $tlfile n2 pt
python $INTP $mlfile $tlfile t pt
...
python $INTP $mlfile $pvfile zh pv
python $INTP $mlfile $pvfile n2 pv
python $INTP $mlfile $pvfile t pv
